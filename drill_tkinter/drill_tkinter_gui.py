...
def load_gui(self):
    ...
    self.txtDir1 = Entry(self.master, text=self.varDir1, font=("Helvetica", 13), fg='black', bg='white', width=33)
    self.txtDir1.grid(row=0, column=1, padx=(40,0), pady=(50,0))

    self.txtDir2 = Entry(self.master, text=self.varDir2, font=("Helvetica", 13), fg='black', bg='white', width=33)
    self.txtDir2.grid(row=1, column=1,  padx=(40,0), pady=(20,0))
